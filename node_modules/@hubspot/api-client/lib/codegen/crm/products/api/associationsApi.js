...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(productId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(productId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/products/{productId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(productId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
