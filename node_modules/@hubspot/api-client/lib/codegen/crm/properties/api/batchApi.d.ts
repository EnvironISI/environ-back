...
export declare class BatchApi {
     ...
     */
    archiveBatch(objectType: string, batchInputPropertyName?: BatchInputPropertyName, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createBatch(objectType: string, batchInputPropertyCreate?: BatchInputPropertyCreate, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    readBatch(objectType: string, batchReadInputPropertyName?: BatchReadInputPropertyName, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
