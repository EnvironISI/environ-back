...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(dealId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(dealId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/deals/{dealId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(dealId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
