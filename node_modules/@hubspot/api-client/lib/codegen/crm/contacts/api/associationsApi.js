...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(contactId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(contactId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/contacts/{contactId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(contactId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
