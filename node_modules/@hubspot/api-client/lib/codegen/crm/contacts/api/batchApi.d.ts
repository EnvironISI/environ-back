...
export declare class BatchApi {
     ...
     */
    archiveBatch(batchInputSimplePublicObjectId?: BatchInputSimplePublicObjectId, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createBatch(batchInputSimplePublicObjectInput?: BatchInputSimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    readBatch(archived?: boolean, batchReadInputSimplePublicObjectId?: BatchReadInputSimplePublicObjectId, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updateBatch(batchInputSimplePublicObjectBatchInput?: BatchInputSimplePublicObjectBatchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
