...
export declare class BatchApi {
     ...
     */
    archiveBatch(fromObjectType: string, toObjectType: string, batchInputPublicAssociation?: BatchInputPublicAssociation, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param batchInputPublicAssociation
     */
    createBatch(fromObjectType: string, toObjectType: string, batchInputPublicAssociation?: BatchInputPublicAssociation, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    readBatch(fromObjectType: string, toObjectType: string, batchInputPublicObjectId?: BatchInputPublicObjectId, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
