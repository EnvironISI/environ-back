...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(quoteId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(quoteId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/quotes/{quoteId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'quoteId' + '}', encodeURIComponent(String(quoteId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(quoteId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
