...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(lineItemId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(lineItemId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/line_items/{lineItemId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(lineItemId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseSimplePublicObjectId");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
