...
class AssociationsApi {
     ...
     * @param toObjectId
     */
    archiveAssociation(ticketId, associatedObjectType, toObjectId, options = { headers: {} }) {
     ...
     * @param toObjectId
     */
    createAssociation(ticketId, associatedObjectType, toObjectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/tickets/{ticketId}/associations/{associatedObjectType}/{toObjectId}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
                .replace('{' + 'associatedObjectType' + '}', encodeURIComponent(String(associatedObjectType)))
     ...
     * @param associatedObjectType
     */
    getAssociations(ticketId, associatedObjectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
